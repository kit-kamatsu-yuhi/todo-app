...
| Command | Description |
|---------|-------------|
| [`+subscribe`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-events-subscribe/SKILL.md) | Subscribe to Workspace events and stream them as NDJSON |
| [`+renew`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-events-renew/SKILL.md) | Renew/reactivate Workspace Events subscriptions |
