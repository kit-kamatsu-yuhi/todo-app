...
- [gws-shared](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-shared/SKILL.md) — Global flags and auth
- [gws-modelarmor](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-modelarmor/SKILL.md) — All filter user-generated content for safety commands
