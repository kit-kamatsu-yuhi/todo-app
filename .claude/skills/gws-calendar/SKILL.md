...
| Command | Description |
|---------|-------------|
| [`+insert`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-calendar-insert/SKILL.md) | create a new event |
| [`+agenda`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-calendar-agenda/SKILL.md) | Show upcoming events across all calendars |
