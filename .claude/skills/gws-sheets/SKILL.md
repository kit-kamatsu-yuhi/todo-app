...
| Command | Description |
|---------|-------------|
| [`+append`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-sheets-append/SKILL.md) | Append a row to a spreadsheet |
| [`+read`](../../../apm_modules/Clickan/dev-harness/.claude/skills/gws-sheets-read/SKILL.md) | Read values from a spreadsheet |
